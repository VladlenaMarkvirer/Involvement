package com.sibur.involvement.server.config;
...
@Configuration
@EnableJpaRepositories("com.sibur.involvement.server.repository")
@EnableTransactionManagement
@ComponentScan("com.sibur.involvement.server")
...
public class DatabaseConfig {
    ...
    /* Если определение datasource в другой конфигурации
    @Autowired
